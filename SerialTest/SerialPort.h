...
typedef void (*MYCALLBACKFUNC)(LPSTR);
...
//General Methods
  ...
  HANDLE GetSerialHnd(){ return m_hComm; }
...
////Callback Methods
  MYCALLBACKFUNC m_pCallbackFunc;
  void SetCallback(MYCALLBACKFUNC pCallbackFunc)
	{
		m_pCallbackFunc = pCallbackFunc;
	}
  void CallException(CString str)
	{
		m_pCallbackFunc((LPSTR)str.GetBuffer(0));
	}
